...
I work on aesthetic theory and the philosophy of history in the nineteenth-century English novel and historiographically grounded computing serving the arts and humanities. 
...
I have designed and conducted [a study of expert users of proof-oriented languages](https://arxiv.org/abs/2508.02733) at [Microsoft Research](https://www.microsoft.com/en-us/research/academic-program/undergraduate-research-internship-computing/), developed methods to [generate domain-specific programs](https://dl.acm.org/doi/abs/10.1145/3618305.3623612) with large language models to democratize diagram authoring at [Carnegie Mellon University](https://www.cmu.edu/scs/s3d/reuse/), and implemented a [programming language](assets/bitfridge-poster.pdf) to safely express program semantics for OS platform- and version-agnostic execution at Williams.
